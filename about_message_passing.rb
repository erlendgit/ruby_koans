...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # sometimes 'send' makes sense in the interface and may be used as something different then method execution
    # '__send__' Is a better 'send'
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Answ: it could be changed to a more gracefull variant
    #
    # NOTE:
    #
