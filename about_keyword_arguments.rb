...
class AboutKeywordArguments < Neo::Koan
  ...
  def test_keyword_arguments_with_wrong_number_of_arguments
    ...
    testimony = method_with_keyword_arguments_with_mandatory_argument(50, two: nil, three: nil)
    assert_equal [50, nil, nil], testimony
  end

  # THINK ABOUT IT:
  #
  # Keyword arguments always have a default value, making them optional to the caller
  # It seems to mean that an argument is not a keyword argument until you provide a default value.
  #
