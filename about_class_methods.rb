...
class AboutClassMethods < Neo::Koan
  ...
  def test_you_can_use_self_instead_of_an_explicit_reference_to_dog
    assert_equal ::AboutClassMethods::Dog.class_method2, Dog.class_method2
  end
  ...
  #
  # The first method implies the right scope, syntacticly correct.
  # The second method is nice because it allows you to group class methods for classes that 
  # use instance methods and class methods heavyly. Not sure if you would want that at all.
  # I think the first method works most of the time. Don't know what the community thinks
